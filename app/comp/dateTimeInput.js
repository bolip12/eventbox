...
class dateTimeInput extends React.Component {
	...
	render() {
		...
		return (
			<View>
				<HelperText style={{marginTop:5, marginBottom:-20, marginLeft:10, color:'green'}}>{this.props.title}</HelperText>
				<List.Item
				    title={valueSelected}
				    right={() => <List.Icon icon={this.props.mode == "date" ? 'calendar' : 'clock-outline'} />}
